<div class="layout">
    ...
    отношении всей информации, которую сайт <strong>DA&amp;BR - Разработка мобильных приложений</strong>, (далее – Рекламный лендинг) расположенный на 
    доменном имени <strong>da-br.ru</strong> (а также его субдоменах), может получить о Пользователе во время использования 
    сайта da-br.ru (а также его субдоменов), его программ и его продуктов.</p>
    ...
    на управление сайтом <strong>DA&amp;BR - Разработка мобильных приложений</strong>, действующие от имени ,
    ...
    <p>1.1.5. «Сайт <strong> DA&amp;BR - Разработка мобильных приложений</strong>» - это совокупность связанных между собой веб-страниц, размещенных в сети Интернет по уникальному 
    адресу (URL): <strong>da-br.ru</strong>, а также его субдоменах.</p>

    <p>1.1.6. «Субдомены»  - это страницы или совокупность страниц, расположенные на доменах третьего уровня, 
    принадлежащие сайту DA&amp;BR - Разработка мобильных приложений, а также другие временные страницы, внизу который указана контактная
    информация Администрации</p>
    
    <p>1.1.5. «Пользователь сайта <strong>DA&amp;BR - Разработка мобильных приложений</strong> » (далее Пользователь) – лицо, имеющее доступ 
    к сайту <strong>DA&amp;BR - Разработка мобильных приложений</strong>, посредством сети Интернет 
    и использующее информацию, материалы и продукты сайта <strong>DA&amp;BR - Разработка мобильных приложений</strong>.</p>
    ...
    <p>2.1. Использование сайта DA&amp;BR - Разработка мобильных приложений Пользователем означает согласие с настоящей Политикой 
    ...
    сайта DA&amp;BR - Разработка мобильных приложений .</p>

    <p>2.3. Настоящая Политика конфиденциальности применяется к сайту DA&amp;BR - Разработка мобильных приложений.
    Рекламный лендинг не контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь 
    может перейти по ссылкам, доступным на сайте DA&amp;BR - Разработка мобильных приложений.</p>
    ...
    регистрации на сайте DA&amp;BR - Разработка мобильных приложений, при подписке на информационную e-mail рассылку или при оформлении заказа.</p>
    
    <p>3.2. Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности, предоставляются 
    Пользователем путём заполнения форм на сайте DA&amp;BR - Разработка мобильных приложений и включают в себя следующую информацию:<br />
    ...
    <p>3.3. Рекламный лендинг защищает Данные, которые автоматически передаются при посещении страниц:<br />
    - IP адрес;<br />
    ...
    <p>3.3.1. Отключение cookies может повлечь невозможность доступа к частям сайта <span>DA&BR - Разработка мобильных приложений ?</span> , требующим 
    авторизации.</p>

    <p>3.3.2. Рекламный лендинг осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация 
    ...
    4.1.1. Идентификации Пользователя, зарегистрированного на сайте DA&amp;BR - Разработка мобильных приложений для его дальнейшей авторизации, оформления заказа 
    и других действий.<br />

    4.1.2. Предоставления Пользователю доступа к персонализированным данным сайта DA&amp;BR - Разработка мобильных приложений.<br />

    4.1.3. Установления с Пользователем обратной связи, включая направление уведомлений, запросов, касающихся использования 
    сайта DA&amp;BR - Разработка мобильных приложений, оказания услуг и обработки запросов и заявок от Пользователя.<br />

    4.1.4. Определения места нахождения Пользователя для обеспечения безопасности, предотвращения мошенничества.<br />

    4.1.5. Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.<br />

    4.1.6. Создания учетной записи для использования частей сайта DA&amp;BR - Разработка мобильных приложений, если Пользователь дал согласие на 
    ...
    сайта DA&amp;BR - Разработка мобильных приложений.<br />
    ...
    исключительно в целях выполнения заказа Пользователя, оформленного на сайте DA&amp;BR - Разработка мобильных приложений, включая доставку Товара, 
    ...
    сайта DA&amp;BR - Разработка мобильных приложений, и давать согласие на их обработку.</p>
    ...
    тексты и т. д.), к которой он может иметь доступ как к части сайта DA&amp;BR - Разработка мобильных приложений, несет лицо, предоставившее 
    такую информацию.</p>
    
    <p>7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта DA&amp;BR - Разработка мобильных приложений, может 
    являться объектом интеллектуальной собственности, права на который защищены и принадлежат другим Пользователям, 
    партнерам или рекламодателям, которые размещают такую информацию на сайте DA&amp;BR - Разработка мобильных приложений. <br />
    ...
    сайте DA&amp;BR - Разработка мобильных приложений) допускается их распространение при условии, что будет дана ссылка 
    на Рекламный лендинг.</p>
    ...
    содержащихся на сайте DA&amp;BR - Разработка мобильных приложений или передаваемых через него.</p>
    ...
    сайте DA&amp;BR - Разработка мобильных приложений, включая, но не ограничиваясь: информацию, защищенную авторским правом, без прямого 
    ...
    <p>9.2. Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте DA&amp;BR - Разработка мобильных приложений, если 
    ...
    адресу: info@devappbroseph.ru</p>
    
    <p>9.4. Действующая Политика конфиденциальности размещена на странице по адресу http://da-br.ru/politika.html</p>

    <p>Обновлено: 27 Ноября 2023 года</p>
    <p>г. Москва, </p>
</div>

<style>
    .layout {width:940px; margin:1em auto; padding:1em 2%}
    h1 {color:var(--white-color); font-size:2.2em; text-align:center}
    h2 {color:var(--white-color); font-size:1.8em; text-align:center}
    h3 {color:var(--white-color); font-size:1.6em; text-align:center}
    p {color:var(--white-color); padding:0 0 0.5em; font:1em Arial; line-height:150%}
</style>